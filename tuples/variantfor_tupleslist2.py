"""
Almacenar en una lista de 5 elementos las tuplas con el nombre de cadaempleado y su sueldo.
Implementar las funciones:
1. Carga de empleados
2. Impresión de los empleados y sus sueldos.
3. Nombre del empleado con su sueldo mayor.
4. Cantidad de empleados con sueldo menor a 1000 por teclado.
"""
def cargar():
    empleados=[]
    for x in range(5):
